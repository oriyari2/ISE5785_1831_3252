...
public class CylinderTest {
    ...
    void testGetNormal() {
        ...
        Point pointOnSide = new Point(1, 0, 2);  // Ensuring Y component is 0
        ...
        Point pointOnTopBase = new Point(0, 0, 5.001); // Slightly above the top base to avoid zero vector
        ...
        Point pointOnBottomBase = new Point(0, 0, -0.001); // Slightly below the bottom base to avoid zero vector
        expectedNormal = new Vector(0, 0, -1);
        ...
        Point centerTop = new Point(0, 0, 5.001); // Adjusted to avoid zero vector
        expectedNormal = new Vector(0, 0, 1);
        ...
        Point centerBottom = new Point(0, 0, -0.001); // Adjusted to avoid zero vector
        expectedNormal = new Vector(0, 0, -1);
        ...
        Point edgeTop = new Point(1, 0, 5);  // Ensuring point is exactly on the radius
        expectedNormal = new Vector(0, 0, 1);
        ...
        Point edgeBottom = new Point(1, 0, 0);  // Ensuring point is exactly on the radius
        expectedNormal = new Vector(0, 0, -1);
